const amazonAry = document.getElementById('amazonItem');
...
fetch(getAmazonUrl(amazonProdukteName))
    ...
    .then((json) => json.forEach((amazonArticles) => {

        aList.push(amazonArticles);


        amazonAry.innerHTML = aList
            .map((a) => {
                return `
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 col-xs-6 col-sm-6 col-11 mx-auto mx-sm-0 mx-md-0 mx-lg-0 mx-xl-0 mb-3">
              <div class="card mb-5 h-100  box-shadow card-litle"  >
